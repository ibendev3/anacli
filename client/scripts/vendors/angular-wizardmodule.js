...
angular.module('ng-wizard', ['templates-angularwizard']);

angular.module('ng-wizard').directive('wzStep', function () {
    return {
        restrict: 'EA',
        replace: true,
        transclude: true,
...
angular.module('ng-wizard').directive('wizard', function () {
    return {
        restrict: 'EA',
        replace: true,
        transclude: true,
...
angular.module('ng-wizard').factory('WizardHandler', function () {
    var service = {};
